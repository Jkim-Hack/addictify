...
class CirclePainter extends CustomPainter {
  ...
  CirclePainter({this.color = Colors.white, this.strokeWidth = 10, this.isAntialias = true, this.paintingStyle = PaintingStyle.stroke, this.radius = 35});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(new Offset(0, 0), this.radius, paint);
